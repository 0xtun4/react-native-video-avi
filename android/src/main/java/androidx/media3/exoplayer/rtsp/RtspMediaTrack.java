...
/* package */ final class RtspMediaTrack {
  ...
  private static void processH264FmtpAttribute(
    ...
    Log.d("processH264FmtpAttribute", "processH264FmtpAttribute: processH264FmtpAttribute");
    if (parameterSets.length == 1) {
      String fakePps = "aGAAA";
      Log.d("processH264FmtpAttribute", "aGAAA: aGAAA");
      parameterSets = new String[]{parameterSets[0], fakePps};
    }
    Log.d("processH264FmtpAttribute", "processH264FmtpAttribute: parameterSets");
  ...
  private static Uri extractTrackUri(
    ...
    Log.d("extractTrackUri", "extractTrackUri: "+ controlAttributeUri +"ok"+ controlAttributeUri.isAbsolute());
